      ...
      <ScrollView>
        ...
        <View style={styles.sectionCard}>
          <View style={styles.sectionHeader}>
            <Text style={styles.sectionTitle}>William's Highlights</Text>
            <TouchableOpacity
        ...
        <View >
          ...
          <View style={styles.wishlistContainer}>
            <View style={styles.wishlistItem}>
              <Ionicons name="location" size={16} color="#FFC107" />
              <Text style={styles.wishlistText}>Paris, France</Text>
            </View>
            <View style={styles.wishlistItem}>
              <Ionicons name="location" size={16} color="#FFC107" />
              <Text style={styles.wishlistText}>Venice, Italy</Text>
            </View>
            <View style={styles.wishlistItem}>
              <Ionicons name="location" size={16} color="#FFC107" />
              <Text style={styles.wishlistText}>Madrid, Spain</Text>
            </View>
          </View>
        </View>
        </TouchableOpacity>
