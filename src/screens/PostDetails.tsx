...
import { 
  ...
  Image, FlatList, ScrollView, TextInput, Dimensions 
} from 'react-native';
            ...
            <View style={styles.ratingContainer}>
               <View style={styles.ratingStars}>
                  <View style={styles.starsContainer}>
                    {[1, 2, 3, 4, 5].map(index => renderStar(index, post.rating))}
                  </View>
          ...
          <View style={styles.imageCarousel}>
            ...
            {activeImageIndex < post.images.length - 1 && (
              <TouchableOpacity 
                ...
                onPress={() => {
                  const nextIndex = Math.min(activeImageIndex + 1, post.images.length - 1);
            ...
            <View style={styles.detailsGrid}>
              <View style={styles.detailItem}>
                ...
                <View>
                  ...
                  <Text style={styles.detailValue}>{post.details.visited}</Text>
                </View>
              </View>
              ...
              <View style={styles.detailItem}>
                ...
                <View>
                  ...
                  <Text style={styles.detailValue}>{post.details.reason}</Text>
                </View>
              </View>
              ...
              <View style={styles.detailItem}>
                ...
                <View>
                  ...
                  <View style={styles.ratingStars}>
                    {[1, 2, 3, 4, 5].map(index => renderStar(index, post.details.safetyRating))}
                    <Text style={styles.smallRatingText}>
                      ({post.details.safetyRating}/5)
                    </Text>
                  </View>
                </View>
              </View>
              ...
              <View style={styles.detailItem}>
                ...
                <View>
                  ...
                  <View style={styles.ratingStars}>
                    {[1, 2, 3, 4, 5].map(index => renderStar(index, post.details.costRating))}
                    <Text style={styles.smallRatingText}>
                      ({post.details.costRating}/5)
                    </Text>
                  </View>
                </View>
              </View>
